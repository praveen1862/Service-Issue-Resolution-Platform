...
<link rel="icon" type="image/x-icon" href="../assets/favicon.ico">
    ...
    <title>Leave your Concerns</title>
</head>
<body>
...
<div class="container">
  ...
  <section>
    <div class="card">
         ...
         <h1 style='font-size: 40px'></span> Leave your complaint about the Online Products 🎫 </p>
       </div>
    ...
    <form action="../handlers/goHome.php" method="POST">
       <button class="homeBtn" href="http://localhost/project/pages/landing.php">Back</button>
    </form>
  </section>
</div>
<?php
